...
namespace SFPEW {
    namespace External {
        ...
        namespace BackendGL {
            ...
            GL_FUNC_TYPEDEF(void, glGetCompressedTexImage, GLenum target, GLint level, void* pixels)
            GL_FUNC_TYPEDEF(void, glGetTexImage, GLenum target, GLint level, GLenum format, GLenum type, void* pixels)
        ...
        struct BackendGLFunctionsTable {
            ...
            GL_FUNC_DECL(glGetCompressedTexImage)
            GL_FUNC_DECL(glGetTexImage)
